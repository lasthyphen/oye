...
Protobuf files are hosted at [https://buf.build/lasthyphen/beacongo](https://buf.build/lasthyphen/beacongo) and can be used as dependencies in other projects.
